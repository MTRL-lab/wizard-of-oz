...
export const gpt3Say = (discussion_id) => {
    ...
    return getDiscussion(discussion_id)
        ...
        // ` +
        `The following is a discussion between an architect and her client. The architect wants the client to express his aesthetic preferences and how he thinks the building could benefit the community. The architect is very kind.
        ` +
...
export const gpt3Brief = (messages) => {
        ...
        const prompt = [
            `Here is a conversation between an architect and her client:`,
            discussion,
