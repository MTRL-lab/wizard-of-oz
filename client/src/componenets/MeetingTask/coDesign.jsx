...
const CoDesignMeetingTask = ({ task,t }) => {
    ...
    const subject = t('Collaborative Design Meeting')
    const summary = t('CoDe-meeting_summary')
    const start = new Date('June 13, 2022 17:00 GMT+03:00')
    const end = new Date('June 13, 2022 20:00 GMT+03:00')
    const meeting = {
        start,
        end,
        summary:subject,
